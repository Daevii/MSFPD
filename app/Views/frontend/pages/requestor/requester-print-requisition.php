                ...
                foreach ($print as $print_order) : ?>
                 <div class="container-fluid d-flex justify-content-between">
                     ...
                     <div class="col-lg-3 pr-0">
                         ...
                         <p>Status :
                             <?php
                                if ($status = $print_order['status'] == 'pending') {
                                    echo ' <span class="badge bg-warning text-dark fw-bolder text-uppercase"> Pending </span>';
                                } else {
                                    echo ' <span class="badge bg-success text-white fw-bolder text-uppercase"> Order Accepted </span>';
                                }
                                ?>
