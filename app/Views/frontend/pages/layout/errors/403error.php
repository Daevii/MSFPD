...
<body>
    ...
    <div class="message2">You tried to access a page you did not have prior authorization for.</div> <br> <br><br>

    <div class="message3 ahref"><a href="<?= base_url('login'); ?>" onclick="  <?php session()->destroy(); ?>" style="color: white; font-size: 30px">Click here to login</a></div>
