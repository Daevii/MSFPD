...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active text-info" aria-current="page">Higher</li>
...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Approver Higher Datatable</h5>
                    ...
                    <tbody>
                        <?php foreach ($invoice as $invoice_list) : ?>
                            <tr>
                                ...
                                <td>
                                    <?php if ($invoice_list['higher_approver_check'] == 'Rejected') {
